...
if(isset($_SESSION['login'])==false){
  ...
  echo '</div>';
          ...
          if($pro_name == ''){
              echo '<div class="text-center" style="color:#56256e;">';
              echo '<h3 style="color:#56256e;">商品名が入力されていません。</h3>';
              echo '</div>';
          }else{
              echo '<div class="text-center" style="color:#56256e;">';
              echo '<br/><br/><h3>商品名：'. $pro_name.'</h3>';
              echo '</div>';
              }

          if(preg_match("/^[0-9]+$/",$pro_price) == 0){
            echo '<div class="text-center" style="color:#56256e;">';
            echo '<br/><h3 style="color:#56256e;">半角数字で入力してください。</h3><br/>';
            echo '<br/>';
            echo '</div>';
          }else{
            echo '<div class="text-center" style="color:#56256e;">';
            echo '<br/><br/><h2>価格：'.$pro_price.'円<br/></h2><br/>';
            echo '</div>';
            }
