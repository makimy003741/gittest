...
if(isset($_SESSION['login'])==false){
  ...
  echo '</div>';
      ...
      try{
          ...
          echo '<h3 style="color:#56256e;">商品一覧</h3><br/><br/>';
          echo'</div>';
          ...
          while(true){
              ...
              echo '<h4>'.$rec['name'].'---'.$rec['price'].'円</h4>';
              echo '<br/>';
          }
          echo '<div class="text-center">';
      ...
      echo '<div class="text-center" >';
      echo'<br/><br/><a href="../staff_login/staff_top.php"><h4 style="color:#d04f97;">トップメニューへ</h4></a><br/>';
      echo '</div>';
