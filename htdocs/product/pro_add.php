...
if(isset($_SESSION['login'])==false){
  ...
  echo'<h1>商品追加</h1><br/>';
  echo'<br/>';
  echo'<form method="post" action="pro_add_check.php" enctype="multipart/form-data">';
  echo'<h3>商品名を入力してください。</h3>';
  echo'<input type="text" name="name" style="width:200px"><br/>';
  echo'<br/><h3>価格を入力してください。</h3>';
  echo'<input type="text" name="price" style="width:50px"><br/>';
  echo'<br/><h3>画像を選んでください。</h3><br/>';
