...
if(isset($_SESSION['login'])==false){
  ...
  echo '<a href="../staff_login/staff_login.html"> <h4 style="color:#d04f97;">ログイン画面へ></h4></a>';
  echo '</div>';
  exit();
}else{
  echo '<div class="text-center" style="color:#56256e;">';
  ...
  echo '</div>';
      ...
      echo '<div class="text-center" style="color:#56256e;">';
      echo'<h2>修正しました。</h2><br/>';
      echo'<br/>';

      echo'<a href="staff_list.php"  button class="btn btn-success">戻る</a>';
